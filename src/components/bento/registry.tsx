...
export const widgetRegistry: Record<string, WidgetRegistryEntry> = {
  ...
  'quick-links':      { label: 'Quick Links',      description: 'Bookmark shortcuts',            component: QuickLinksWidget,      defaultW: 2, defaultH: 1, minW: 2, minH: 2, maxW: 6, maxH: 2,  category: 'Organization' },
  ...
  'recent':           { label: 'Recent',           description: 'Recently opened pages',         component: RecentWidget,          defaultW: 4, defaultH: 2, minW: 2, minH: 2, maxW: 6, maxH: 3,  category: 'General' },
};
