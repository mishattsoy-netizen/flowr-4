    ...
    <div className="space-y-[10px] animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-[10px] items-start">
        <div className="lg:col-span-1">
           <div className="bg-sidebar group/widget px-5 pb-5 pt-4 rounded-[var(--radius-big)] widget-shadow h-full flex flex-col sticky top-10 transition-all duration-200 hover:bg-white/[0.02] hover:-translate-y-0.5">
