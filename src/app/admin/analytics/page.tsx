...
export default async function AnalyticsPage() {
  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-500">
      <div className="mb-2">
        <h1 className="text-4xl font-display font-medium text-foreground mb-1">Analytics & Insights</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-sidebar group/widget border border-[var(--bone-12)] px-5 pb-5 pt-4 rounded-[var(--radius-big)] widget-shadow h-full flex flex-col space-y-4 relative overflow-hidden">
          ...
          <div className="space-y-1 relative z-10">
            ...
            <p className="text-[9px] text-bone-70 opacity-30 font-bold uppercase tracking-tight">Most discussed categories by users.</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 relative z-10 pt-4 border-t border-[var(--bone-12)]">
            {topics.map((t: any, i: number) => (
              <div key={t.name} className="flex items-center justify-between gap-3 bg-background/50 border border-[var(--bone-12)] p-2 rounded-regular group hover:border-accent/20 transition-all">
                ...
                <span className="text-[10px] font-mono font-bold text-bone-70 opacity-20 group-hover:opacity-100">{t.value}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-sidebar group/widget border border-[var(--bone-12)] px-5 pb-5 pt-4 rounded-[var(--radius-big)] widget-shadow h-full flex flex-col space-y-4 relative overflow-hidden">
          <div className="space-y-1">
            ...
            <p className="text-[9px] text-bone-70 opacity-30 font-bold uppercase tracking-tight">Daily interaction trends over time.</p>
          </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-[9px] text-bone-70 opacity-30 font-bold uppercase tracking-tight">Distribution of specialized AI tasks.</p>
        </div>
        <div className="h-64">
