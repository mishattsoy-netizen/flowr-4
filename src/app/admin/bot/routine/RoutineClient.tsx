...
export default function RoutineClient({ initialPlans }: Props) {
  ...
  return (
    <div className="space-y-5 animate-in fade-in duration-500">
      <div className="mb-2">
        <h1 className="text-4xl font-display font-medium text-foreground mb-1">Routine</h1>
      ...
      {/* Controls */}
      <div className="bg-[var(--bone-6)] border border-[var(--bone-12)] rounded-xl p-4 flex flex-col gap-4">
      ...
      <div className="bg-panel border border-[var(--bone-12)] rounded-xl px-4 py-2 flex flex-wrap items-center gap-x-6 gap-y-1.5">
        ...
        return (
          <div className="space-y-3">
            ...
            {filteredPlans.map(plan => {
              ...
              return (
                <div key={plan.id} className="bg-[var(--bone-6)] border border-[var(--bone-12)] rounded-xl overflow-hidden">
                  {/* Card header */}
                  <div
                    className="flex items-center gap-3 p-4 border-b border-[var(--bone-6)] cursor-pointer hover:bg-[var(--bone-8)]"
                  ...
                  {/* Expanded content */}
                  {isExpanded && (
                    <div className="px-4 py-3 bg-[var(--bone-10)] border-t border-[var(--bone-6)] space-y-3">
                      <div className="pt-3">
                      ...
                      <div className="flex items-center gap-2 py-1">
                        ...
                        <select
                          ...
                          className="bg-background border border-[var(--bone-6)] rounded px-2.5 py-1 text-xs text-foreground focus:outline-none focus:ring-1 focus:ring-[var(--bone-30)] font-medium"
                        >
