...
export default function ClassifierPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 max-w-5xl">
      <div>
        <h1 className="text-4xl font-display font-medium text-foreground mb-1 select-none flex items-center gap-2.5">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="bg-panel rounded-big border border-bone-12 p-5 space-y-4">
        ...
        <div className="bg-panel rounded-big border border-bone-12 p-5 space-y-4">
          ...
          <div className="space-y-4 pt-2">
            {Object.keys(CATEGORY_LABELS).map(cat => (
              <div key={cat} className="space-y-1.5 p-3.5 bg-background/50 border border-[var(--bone-6)] rounded-xl hover:border-white/[0.05] transition-all">
                ...
                <input
                  ...
                  className="w-full bg-background/60 border border-[var(--bone-6)] rounded-lg px-3 py-2 text-xs text-foreground placeholder:text-muted-foreground/20 focus:outline-none focus:border-accent transition-all font-sans"
                />
              </div>
            ))}
          </div>
      ...
      <div className="flex items-center justify-between bg-panel border border-bone-12 p-4 rounded-big">
