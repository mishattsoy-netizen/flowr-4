  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
         <div className="bg-sidebar group/widget px-5 pb-5 pt-4 rounded-[var(--radius-big)] widget-shadow h-full flex flex-col instrument-hover cursor-default transition-all duration-200 hover:bg-white/[0.02] hover:-translate-y-0.5">
       ...
       <div className="bg-sidebar group/widget px-5 pb-5 pt-4 rounded-[var(--radius-big)] widget-shadow h-full flex flex-col overflow-hidden transition-all duration-200 hover:bg-white/[0.02] hover:-translate-y-0.5">
